(function (window, document, $, undefined) {
    ...
    var jobRadarJs = {
        ...
        methods: function (e) {
            jobRadarJs.smothScroll();
            jobRadarJs.backToTopInit();
            jobRadarJs.backToTopInit();
            jobRadarJs.counterUpActivation();
            jobRadarJs.wowActivation();
            jobRadarJs.headerTopActivation();
            jobRadarJs.headerSticky();
            jobRadarJs.salActive();
            jobRadarJs.popupMobileMenu();
            jobRadarJs.masonryActivation();
            jobRadarJs.magnigyPopup();
            jobRadarJs.lightBoxJs();
            jobRadarJs.slickSliderActivation();
            jobRadarJs.radialProgress();
            jobRadarJs.contactForm();
            jobRadarJs.menuCurrentLink();
            jobRadarJs.onePageNav();
        },
